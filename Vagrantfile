...
Vagrant.configure("2") do |config|
    ...
    config.vm.define "fast-afpacket-101" do |boxconfig|
        boxconfig.vm.box = "ubuntu/bionic64"
        
        boxconfig.vm.hostname = "fast-afpacket-101"
        
        boxconfig.vm.network "private_network", ip: "192.168.56.101", :mac => "0242acc80161"
        boxconfig.vm.provision :shell, run: "always", inline: "ip address replace fde4:8dba:82e1::c1/64 dev enp0s8"

        boxconfig.vm.provision :shell, run: "always", inline: "ip neigh replace 192.168.56.102 lladdr 02:42:ac:c8:01:62 dev enp0s8 nud reachable"
        boxconfig.vm.provision :shell, run: "always", inline: "ip neigh replace fde4:8dba:82e1::c2 lladdr 02:42:ac:c8:01:62 dev enp0s8 nud reachable"
    end
    ...
    config.vm.define "fast-afpacket-102" do |boxconfig|
        ...
        boxconfig.vm.provision :shell, run: "always", inline: "ip address replace fde4:8dba:82e1::c2/64 dev enp0s8"

        boxconfig.vm.provision :shell, run: "always", inline: "ip neigh replace 192.168.56.101 lladdr 02:42:ac:c8:01:61 dev enp0s8 nud reachable"
        boxconfig.vm.provision :shell, run: "always", inline: "ip neigh replace fde4:8dba:82e1::c1 lladdr 02:42:ac:c8:01:61 dev enp0s8 nud reachable"
    end
